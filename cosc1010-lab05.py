...
print(f"There are {pos_occur} positive numbers in the list.")
print(f"There are {odd_occur} negative numbers in the list.")
print(f"Zero occured {zero_occur} times in the list.")        
